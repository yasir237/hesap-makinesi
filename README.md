...
19. **Trigonometrik Fonksiyonlar (sin, cos, tan, cot):** Bu butonlar, trigonometrik fonksiyonları kullanarak matematiksel hesaplamalar yapar.
  - Sinüs (sin): Bir açının sinüs değerini hesaplar. Örneğin, sin(30°) = 0.5.
  - Kosinüs (cos): Bir açının kosinüs değerini hesaplar. Örneğin, cos(60°) = 0.5.
  - Tanjant (tan): Bir açının tanjant değerini hesaplar. Örneğin, tan(45°) = 1.
  - Kotanjant (cot): Bir açının kotanjant değerini hesaplar. Örneğin, cot(45°) = 1.
